...
.factory('MyServices', function($http) {
    ...
    return {
        ...
        saveContacts: function(contacts, callback) {
            $http.post(adminurl + "user/saveContacts", {
                "contacts": contacts
            }).success(callback);
        },
        getContacts: function(callback) {
            $http.post(adminurl + "user/getContacts").success(callback);
        },
        sendNotification: function(request, callback) {
            $http.post(adminurl + "notification/sendNotification", {
                "request": request
            }).success(callback);
        },
        ...
        addAndShare: function(contact, callback) {
            $http.post(adminurl + "notification/addAndShare", contact).success(callback);
        },
